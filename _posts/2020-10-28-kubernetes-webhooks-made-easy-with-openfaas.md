...
date: 2020-10-28
image: /images/2020-10-28-k8s-validatingwebhook-openfaas/admission-controller-phases.png
categories:
  - arkade
  - kubectl
  - faas-cli
...
<p align="center">
<img height="128" src="/images/openfaas_dark.png">
</p>

<p align="center">
<img height="128" src="/images/2020-10-28-k8s-validatingwebhook-openfaas/heart.png">
</p>
...
### 1. Setup a Kubernetes Cluster with Kind (Optional)
...
### 3. Clone the project
* First , you must clone a project from Github
...
```yaml
 env:
   ...
   - name: FUNCTION_NAMESPACE
     value: openfaas-fn
```
by doing that you don't need to rebuild the go code , you just re-deploy the webhook server.
