---
title: "Zero-code Instrumentation for OpenFaaS Functions with OpenTelemetry"
description: "Learn how to capture telemetry data for OpenFaaS functions without modifying your code."
date: 2025-05-09
...
Zero-code instrumentation for OpenFaaS function with OpenTelemetry

Why would you instrument OpenFaaS functions?
...
Traces can be a great addition to the wide [range of Prometheus metrics](https://docs.openfaas.com/architecture/metrics/) OpenFaaS already makes available for monitoring functions.

![](/images/2025-05-opentelemetry/function-otel-collection-diagram.png)
...
Tempo uses Object storage to store its data. We are going to use MinIO as the storage backend which is included in the Helm chart for demonstration purposes only. When using Tempo in production you should configure a different storage option. Tempo supports S3 compatible storage backends like [AWS S3](https://aws.amazon.com/pm/serv-s3/), [Azure Blob storage](https://azure.microsoft.com/en-us/products/storage/blobs), [Google Cloud Storage](https://cloud.google.com/storage), etc.
...
In this example we will show how you can use auto instrumentation with two of our most popular commonly used function languages, Node.Js and Python. We will use the second option to modify the templates and patch them directly in the `./template` directory.

### Instrument a NodeJS function
...
We ran through the process of deploying and configuring a [Collector](https://opentelemetry.io/docs/collector/), and tracing backend to collect and store traces for OpenFaaS functions.
